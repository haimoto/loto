...
_PRECOMPUTED_BEST_FOUND_PORTFOLIOS = {
    ...
    # fail3=3684920, exact any3=39.5563% (best-found)
    ('loto6', 16): (
        (9, 12, 13, 25, 30, 40),
        (6, 11, 16, 21, 34, 39),
        (3, 8, 10, 26, 39, 41),
    ...
    # fail3=3562131, exact any3=41.5704% (best-found)
    ('loto6', 17): (
        (8, 12, 19, 24, 27, 35),
        (6, 9, 19, 26, 30, 33),
        (13, 17, 18, 21, 28, 30),
    ...
    # fail3=3446997, exact any3=43.4590% (best-found)
    ('loto6', 18): (
        (2, 9, 15, 24, 35, 42),
        (2, 14, 20, 21, 27, 43),
        (3, 12, 21, 22, 32, 37),
    ...
    # fail3=708921, exact any3=93.1142% (best-found)
    ('loto7', 16): (
        (9, 12, 14, 15, 17, 31, 36),
        (3, 12, 13, 21, 24, 27, 34),
        (2, 8, 16, 17, 25, 29, 37),
    ...
    # fail3=407876, exact any3=96.0383% (best-found)
    ('loto7', 19): (
        (2, 7, 15, 20, 27, 28, 33),
        (1, 10, 13, 18, 26, 29, 36),
        (5, 12, 16, 18, 19, 27, 33),
    ...
    # fail3=345176, exact any3=96.6473% (best-found)
    ('loto7', 20): (
        (1, 5, 12, 22, 25, 32, 36),
        (6, 14, 17, 19, 22, 23, 28),
        (6, 7, 18, 21, 25, 26, 31),
